...
Matrix3x3::Matrix3x3() : Object(), identity(false)
{
    for (int i = 0; i < 3; ++i)
    {
        for (int j = 0; j < 3; ++j)
...
Matrix3x3::Matrix3x3(const float tempArr[3][3]) : Object(), identity(false)
{
    for (int i = 0; i < 3; ++i)
    {
        for (int j = 0; j < 3; ++j)
...
Matrix3x3::Matrix3x3(const Matrix3x3 &other) : Object(other), identity(other.identity)
{
    for (int i = 0; i < 3; ++i)
    {
        for (int j = 0; j < 3; ++j)
...
Matrix3x3 Matrix3x3::transposeMatrix3x3()
{
    Matrix3x3 res(*this);
    for (int i = 0; i < 3; ++i)
    {
...
Matrix3x3 Matrix3x3::createRandomMatrix(float minVal, float maxVal)
{
